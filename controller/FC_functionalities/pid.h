...
void calculate_pid(__int32_t pid_pitch_setpoint_base, __int32_t pid_roll_setpoint_base) {
    ...
    // printf("gyro_yaw_input: %f  pid_yaw_setpoint:%f \n", gyro_yaw_input,pid_yaw_setpoint);
}
